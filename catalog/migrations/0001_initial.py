...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('language', models.CharField(choices=[('en', 'English'), ('ru', 'Russian'), ('de', 'Deutsch'), ('ua', 'Ukrainian'), ('fr', 'French'), ('jp', 'Japanese')], default='en', help_text="The book's natural language (e.g. English, French, Japanese etc.)", max_length=2)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
